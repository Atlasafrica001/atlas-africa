      ...
      <section className="-mt-12 py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-36 flex justify-center">
                <button className="bg-[#D4AF37] border border-[#000000] text-[#000000] bg-opacity-50 px-6 py-2 rounded-lg font-medium shadow-sm shadow-black hover:bg-atlas-gold hover:text-white transition-colors flex items-center gap-2">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 24 24"
